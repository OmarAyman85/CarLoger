...
class Rescuecranes extends StatefulWidget {
  const Rescuecranes({Key? key}) : super(key: key);

  @override
  State<Rescuecranes> createState() => _RescuecranesState();
}

class _RescuecranesState extends State<Rescuecranes> {
  final CollectionReference Rescuecranes =
      FirebaseFirestore.instance.collection('cranes');
  int activeIndex = 0;
